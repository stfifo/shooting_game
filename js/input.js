// ── Input ────────────────────────────────────────────────────────
const keys=new Set();
const KEY_VIS={ArrowUp:'ku',KeyW:'ku',ArrowDown:'kd',KeyS:'kd',ArrowLeft:'kl',KeyA:'kl',ArrowRight:'kr',KeyD:'kr',KeyZ:'k-z',KeyX:'k-x',KeyP:'k-p',Space:'k-start',Enter:'k-start'};
...
addEventListener('keydown',e=>{
  ...
  if(e.code==='KeyP'){if(STATE==='PLAYING')STATE='PAUSED';else if(STATE==='PAUSED')STATE='PLAYING';}
