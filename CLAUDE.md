...
- **티어별 스케일링**: HP=`80+tier*90`(tier1→170, tier6→620), 이동속도 배율=`0.6+tier*0.1`, 발사간격 배율=`1.8-tier*0.2`.
...
|---|---|---|---|---|---|---|---|
| 1 | 5 | 170 | ×0.7 | ×1.6 (느림) | 없음 | 1,800 | 일반 |
| 2 | 10 | 260 | ×0.8 | ×1.4 | A-LINE5 (5기) | 2,400 | 일반 |
| 3 | 15 | 350 | ×0.9 | ×1.2 | A-LINE5 + B-TWIN2 | 3,000 | 일반 |
| 4 | 20 | 440 | ×1.0 | ×1.0 | A-LINE5 + B-TWIN2 | 3,600 | 일반 |
| 5 | 25 | 530 | ×1.1 | ×0.8 | A-LINE5 + B-TWIN2 + C-ARROW7 | 4,200 | **혼돈** |
| 6 | 30 | 620 | ×1.2 | ×0.6 | A-LINE5 + B-TWIN2 + C-LINE7 | 4,800 | **혼돈** |
